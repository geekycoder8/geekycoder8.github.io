                        ...
                        <div className="flex flex-row my-8 justify-between">
                            <div className="w-5/6">
                                <motion.p
                                    ...
                                    transition={{ delay: 1 }}
                                >
                                    Hello, My name is Mohamed Faisal. A passionate programmer who loves solving complex problems.
                                </motion.p>
                                <br />
                                <motion.p
                                    initial={{ y: 20, opacity: 0 }}
                                ...
                                >
                                    ...
                                    where lines of code converge to shape ideas into reality.
                                    As a software developer, I embark on a continuous quest to innovate, solve, and build.
                                    Join me as I showcase my journey through the realm of programming,
                                    highlighting the projects that reflect my dedication to elegant solutions and functional design.
                                </motion.p>
                                <br />
                                <motion.div
                                    initial={{ y: 20, opacity: 0 }}
                                ...
                                >
                                    ...
                                    <div className="w-5/6">
                                        <div className="h-auto w-auto text-center float-left">
                                            <img className="p-1" src="https://img.shields.io/badge/-HTML-E34F26?logo=html5&logoColor=white&style=for-the-badge" alt="" />
                                        </div>
                                        <div className="h-auto w-auto text-center float-left">
                                            <img className="p-1" src="https://img.shields.io/badge/-CSS-1572B6?logo=css3&logoColor=white&style=for-the-badge" alt="" />
                                        </div>
                                        <div className="h-auto w-auto text-center float-left">
                                        ...
                                        <div className="h-auto w-auto text-center float-left">
                                            <img className="p-1" src="https://img.shields.io/badge/-Git-F05032?logo=git&logoColor=white&style=for-the-badge" alt="" />
                                        </div>
                                    </div>
                                    <br />
                                </motion.div>
